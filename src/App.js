        ...
        <div className="App">
          <div className="App-header">
            ...
            <h2>
              ...
              &nbsp;helps you conduct different types of reviews and audits<br/>and is powered by content from this <a target="_blank" rel="noopener noreferrer" href="https://app.getguru.com/boards/yiKXnGpi/Transcriber">Guru board</a>&nbsp;&nbsp;&nbsp;<span className="version">v0.1.2</span></h2>
          </div>
